			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height: 250,
					colNames:['借阅证卡号','有效日期','姓名', '会员类型', '性别','预存金额'],
					colModel:[
						{name:'cardID',index:'cardID', width:60, sorttype:"int", editable: true},
						{name:'per_of_val',index:'per_of_val',width:90, editable:true, sorttype:"date",unformat: pickDate},
				...
				jQuery(grid_selector).jqGrid('navGrid',pager_selector,
					...
					{
						//删除记录
                        url: "../DeleteDataFromUser",
                        delData: {'cardID':'123'},//此处应该思考如何传入实时参数
                        checkOnSubmit: false,
						recreateForm: true,
						beforeShowForm : function(e) {
							var form = $(e[0]);
