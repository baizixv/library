	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default">
			...
			<div id="navbar-container" class="navbar-container">
				<button  type="button"  data-target="#sidebar"
                         id="menu-toggler" class="navbar-toggle menu-toggler pull-left">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/Library/admin/index.jsp">图书馆管理系统</a>
							</li>
			...
			jQuery(function($) {
				...
				$(document).on('settings.ace.jqGrid' , function(ev, event_name, collapsed) {
					if( event_name === 'sidebar_collapsed' || event_name === 'main_container_fixed' ) {
                        //webkit的定时器setTimeout仅仅在DOM改变并且重载时生效
						setTimeout(function() {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
						...
						{name:'index',index:'index', width:60, editable: true},
						{name:'pressdate',index:'pressdate',width:90, editable:true},
						{name:'bookname',index:'bookname', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},

						{name:'author',index:'author', width:70, editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'press',index:'press', width:100,editable: true,editoptions:{size:"20",maxlength:"30"}},

						{name:'price',index:'price', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
					],

					viewrecords : true,
                   // emptyrecords : "目前没有图书入库！",
					rowNum:10,
					rowList:[10,20,30],
					pager : pager_selector,
					altRows: true, //隔行显示，白蓝交替
                    caption: "图书信息",
					// toppager: true,
                    ...
                    //     page: "page",   // json中代表当前页码的数据，初始的页码
					...
					//editurl: "../GetDataFromCategory",//处理编辑的URL
					autowidth: true,

				});


                //窗口改变大小时触发事件使得grid获得正确的尺寸
				...
				jQuery(grid_selector).jqGrid('navGrid',pager_selector,
					...
					{
						//删除记录
                        url: "../DeleteDataFromCategory",
                        delData: {'index':'12345'},//此处应该思考如何传入实时参数
                        checkOnSubmit: false,
						recreateForm: true,
						beforeShowForm : function(e) {
							var form = $(e[0]);
