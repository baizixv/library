									...
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												while(hh.next()){
											%>	
															<span class="white"><%=hh.getString("name") %></span>
															<%} %>
														</a>
										...
										<div class="col-xs-12 col-sm-9">
											<div class="center">
											<%
												count=user.getUserCommentAverage();
												while(count.next()){
											%>
												<span class="btn btn-app btn-sm btn-light no-hover">
													<span class="line-height-1 bigger-170 blue"><%=count.getString("num") %></span>

													<br />
												总评论数</span>

											  <span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170"> <%=count.getString("avg_score") %> </span>
											...
											<div class="profile-user-info profile-user-info-stiped">
												...
												%>
															<div class="profile-activity clearfix">
																...
																<div>
																	...
																	<a class="user" href="#"><%=rs.getString("bookname")%> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																	 <i class="ace-icon fa fa-clock-o bigger-110"></i>教师打分：<%=rs.getString("score")%>分
																	<div class="time">
																	<%=rs.getString("remark")%></div>
															  </div>														
															</div>
															<%}%>
															</div>													
