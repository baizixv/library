...
<link href="/Library/assets/css/base.css" type="text/css"
	rel="stylesheet" />
			...
			<div class="navbar-buttons navbar-header pull-right"
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a href="/Library/vip/login.jsp"> <img
							...
							alt="Jason's Photo" />更换用户<i class="ace-icon fa fa-caret-down"></i>
					</a></li>
				</ul>
			</div>
		</div>
...
triangle red bigger-130"></i>
				...
				<li class=""><a href="/Library/vip/information.jsp"> <i
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li><i class="ace-icon fa fa-home home-icon"></i>图书馆管理系统</li>
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							图书馆管理系统<small> <i
								class="ace-icon fa fa-angle-double-right"></i>首页
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								...
								<script type="text/javascript"
									src="/Library/assets/js/jquery.select.js"></script>
									...
									<div class="widget-box">
										<div
											...
											<h5 class="widget-title">
												<i class="ace-icon fa fa-signal"></i> 馆藏图书
											</h5>
									...
									<div class="widget-box transparent">
										<div class="widget-header widget-header-flat">
											<h4 class="widget-title lighter">
												<i class="ace-icon fa fa-star orange"></i> 热搜榜
											</h4>
											...
											<div class="widget-main no-padding">
												<table class="table table-bordered table-striped">
													<thead class="thin-border-bottom">
														<tr>
															<th><i class="ace-icon fa fa-caret-right blue"></i>书名
															</th>

															<th><i class="ace-icon fa fa-caret-right blue"></i>索书号
															</th>

															<th class="hidden-480"><i
																class="ace-icon fa fa-caret-right blue"></i>作者</th>
														</tr>
													</thead>
													...
													<tbody>
														<tr>
															...
															<td><s class="blue"><%="TP" + book.getString("index")%></s>
															</td>

															<td class="hidden-480"><span
																class="label label-info arrowed-right arrowed-in"><%=book.getString("author")%></span>
															</td>
														</tr>
														<%
															}
									...
									<div class="widget-box">
										<div class="widget-header">
											<h4 class="widget-title lighter smaller">
												<i class="ace-icon fa fa-comment blue"></i>热门评论
											</h4>
										</div>
														...
														<div class="body">
															<div class="time">
																<i class="ace-icon fa fa-clock-o"></i> <span
																	class="green"><%=remark.getString("bookname")%></span>
															</div>
													...
													<div class="itemdiv dialogdiv">
														<div class="user">
															<img alt="Bob's Avatar"
																src="/Library/assets/avatars/user.jpg" />
														</div>
