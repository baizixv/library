...
<link rel="stylesheet" href="/Library/assets/css/chosen.min.css" />
<link rel="stylesheet" href="/Library/assets/css/datepicker.min.css" />
<link rel="stylesheet"
	href="/Library/assets/css/bootstrap-timepicker.min.css" />
<link rel="stylesheet"
	href="/Library/assets/css/daterangepicker.min.css" />
<link rel="stylesheet"
	href="/Library/assets/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet" href="/Library/assets/css/colorpicker.min.css" />
	...
	<div id="navbar" class="navbar navbar-default">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="/Library/vip/index.jsp" class="navbar-brand"> <small>
						<i class="fa fa-leaf"></i> 图书馆管理系统
				</small>
				</a>
			</div>
			...
			<div class="navbar-buttons navbar-header pull-right"
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a href="/Library/vip/login.jsp"> <img
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				<li class="active"><a href="/Library/vip/index.jsp"> <i
						class="menu-icon fa fa-tachometer"></i>主页
				</a> <b class="arrow"></b></li>

				<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-list"></i>借阅记录<b
					...
					<ul class="submenu">
						...
						<li class=""><a href="/Library/vip/tables.jsp"> <i
								class="menu-icon fa fa-caret-
...
right"></i> 预约信息
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
						class="menu-icon fa fa-file-o"></i>违章记录<b
						class="arrow fa fa-angle-down"></b>
				</a> <b class="arrow"></b>
					...
					<ul class="submenu">
						...
						<li class=""><a href="/Library/vip/hurryup.jsp"> <i
								class="menu-icon fa fa-caret-
...
right"></i> 催还单
						...
						<li class=""><a href="/Library/vip/fine.jsp"> <i
								class="menu-icon fa fa-caret-
...
right"></i> 违章罚款
				...
				<li class=""><a href="/Library/vip/hot.jsp"> <i
						class="menu-icon fa fa-list-alt"></i>风云榜
				</a> <b class="arrow"></b></li>
				<li class=""><a href="/Library/vip/comment.jsp"> <i
						class="menu-icon fa fa-pencil-square-o"></i> <span
						class="menu-text">我的评论<span
							class="badge 

badge-transparent tooltip-error"
							title="2 Important 

Events"> <i
								class="ace-icon fa fa-exclamation-
...
triangle red bigger-130"></i>
				...
				<li class=""><a href="form-elements.jsp"> <i
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							会员信息<small> <i class="ace-icon fa fa-angle-double-right"></i></small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" method="post"
								action="/Library/ModifyUser">

								<%
									rs = Administrator.searchUser(user.cardID);
									while (rs.next()) {
								%>
								<div class="row">
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														<label for="form-field-8">姓名</label> <input type="text"
															class="form-control" id="form-field-1"
															placeholder="Default Text" name="name"
															value=<%=rs.getString("name")%> readonly="readonly">
													</div>

													<hr />

													<div>
														<label for="form-field-9">学号</label> <input type="text"
															class="form-control limited" id="form-field-2"
															name="stu_ID" value=<%=rs.getString("StudentID")%>
															maxlength="50" readonly="readonly">
													</div>

													<hr />
													<div>
														<label for="form-field-9">性别</label> <input type="text"
															class="form-control limited" id="form-field-4" name="sex"
															value=<%=rs.getString("sex")%> maxlength="50" readonly="readonly">
													</div>

													<hr />
													<div>
														<label for="form-field-9">联系电话</label> <input type="text"
															class="form-control limited" id="form-field-5" name="tel"
															value=<%=rs.getString("telephone")%> maxlength="50">
													</div>
													<hr />
													<div>
														<label for="form-field-9">修改密码</label> <input
															type="password" class="form-control limited"
															id="form-field-7" name="pwd" value="" maxlength="50">
													</div>
												</div>
											</div>
												...
												<input class="btn btn-info" type="submit" name="ModifyUser"
												value="修改"">
									...
									<div class="col-xs-12 col-sm-4">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">借阅证信息</h4>
											</div>

											<div class="widget-body">
												<div class="widget-main">
													<div>
														<label for="form-field-mask-1"> 借阅证卡号 </label>

														<div class="input-group"><%=rs.getString("cardID")%>
													...
													<hr />
													<div>
														<label for="form-field-mask-2"> 借阅证类型 </label>

														<div class="input-group">
															<%=rs.getString("TypeOfCard")%>
														</div>
													</div>

													<hr />
													<div>
														<label for="form-field-mask-3"> 加入时间 </label>
													...
													<hr />
													<div>
														<label for="form-field-mask-4"> 借阅证有效期 </label>

														<div>
															<%=rs.getString("per_of_val")%>
														</div>
													</div>
													<hr />
													<div>
														<label for="form-field-mask-4"> 预存金额 </label>

														<div>
															<%=rs.getString("money_Reserved")%>
														</div>
													</div>
												</div>
											</div>
...
<![endif]-->
	...
	<script src="/Library/assets/js/chosen.jquery.min.js"></script>
	<script src="/Library/assets/js/fuelux.spinner.min.js"></script>
	<script src="/Library/assets/js/bootstrap-datepicker.min.js"></script>
	<script src="/Library/assets/js/bootstrap-timepicker.min.js"></script>
	<script src="/Library/assets/js/moment.min.js"></script>
	<script src="/Library/assets/js/daterangepicker.min.js"></script>
	<script src="/Library/assets/js/bootstrap-datetimepicker.min.js"></script>
	<script src="/Library/assets/js/bootstrap-colorpicker.min.js"></script>
	<script src="/Library/assets/js/jquery.knob.min.js"></script>
	<script src="/Library/assets/js/jquery.autosize.min.js"></script>
	<script src="/Library/assets/js/jquery.inputlimiter.1.3.1.min.js"></script>
	<script src="/Library/assets/js/jquery.maskedinput.min.js"></script>
	<script src="/Library/assets/js/bootstrap-tag.min.js"></script>
