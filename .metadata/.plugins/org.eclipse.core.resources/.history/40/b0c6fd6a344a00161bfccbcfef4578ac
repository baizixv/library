			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:[' ', '借阅证卡号','有效日期','姓名', '会员类型', '状态','预存金额'],
					colModel:[
						...
						{name:'stock',index:'stock', width:70, editable: true,edittype:"select",editoptions: {value:"stu:学生;tea:老师"}},
						{name:'ship',index:'ship', width:90, editable: true,edittype:"checkbox",editoptions:{value:"无效:有效"},unformat: aceSwitch},
