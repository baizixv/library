...
public class GetDataFromUser extends  HttpServlet{
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)
        ...
        UserDAO cg = new UserDAO();
        ResultSet preoutput = null;
        
        String sql = "SELECT `cardID`,name,sex,TypeOfCard,per_of_val,money_Reserved FROM user";
        try {
