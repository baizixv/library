										...
										<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											%>
												<tr>
													...
													<td class="hidden-480">
														<span class="label label-sm label-warning">已还</span>
													</td>
												</tr>
												<%}%>
											</tbody>
...
<![endif]-->
		...
		<script src="/Library/assets/js/jquery.dataTables.min.js"></script>
		<script src="/Library/assets/js/jquery.dataTables.bootstrap.min.js"></script>
		<script src="/Library/assets/js/dataTables.tableTools.min.js"></script>
		<script src="/Library/assets/js/dataTables.colVis.min.js"></script>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				var tableTools_obj = new $.fn.dataTable.TableTools( oTable1, {
					"sSwfPath": "/Library/assets/swf/copy_csv_xls_pdf.swf",
