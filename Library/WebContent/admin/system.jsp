...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<head>
		...
		<link rel="stylesheet" href="/Library/assets/css/bootstrap-timepicker.min.css" />
		<link rel="stylesheet" href="/Library/assets/css/daterangepicker.min.css" />
		<link rel="stylesheet" href="/Library/assets/css/bootstrap-datetimepicker.min.css" />
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 最大借阅数量 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="最大借阅数量" class="col-xs-10 col-sm-5" />
										</div>
									</div>

	<div class="form-group">
	  <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">图书分馆 </label>
										<span class="col-sm-9">
										<input type="text" id="form-field-1-1" placeholder="图书分馆" class="col-xs-10 col-sm-5" />
										</span>

										<div class="col-sm-9"></div>
									</div>
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">超期罚款金额</label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="金额" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                   
									<div class="form-group">
									  <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 借阅期限</label>

									  <div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="期限" class="col-xs-10 col-sm-5" />
										</div>
	</div>
	...
	</div><!-- /.col --><!-- /.main-content --><a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
		<i class="ace-icon fa fa-angle-double-up icon-only bigger-110"></i>
	</a><!-- inline scripts related to this page -->
