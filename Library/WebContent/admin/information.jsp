	...
	<div id="navbar" class="navbar navbar-default">
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="/Library/admin/index.jsp" class="navbar-brand"> <small>
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="/Library/admin/hot.jsp"> <i
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							管理员信息<small> <i class="ace-icon fa fa-angle-double-right"></i></small>
						</h1>
					</div>
					<!-- /.page-header -->
								...
								<div class="row">
									<div class="col-xs-12 col-sm-4">
										<div class="widget-box">
												...
												<div class="widget-main">
													...
													<div>
														<label for="form-field-8">姓名</label> <input type="text"
															...
															placeholder="Default Text" name="username"
													...
													<div>
														<label for="form-field-9">id</label> <input type="text"
															class="form-control limited" id="form-field-2"
															name="id" value=<%=rs.getString("id")%>
															maxlength="50">
													</div>
													...
													<div>
														<label for="form-field-9">性别</label> <input type="text"
															...
															value=<%=rs.getString("sex")%> maxlength="50">
													</div>

													<hr />
													<div>
														<label for="form-field-9">密码</label> <input type="text"
															class="form-control limited" id="form-field-5" name="password"
															value=<%=rs.getString("password")%> maxlength="50">
													</div>
													<hr />
													<div>
											...
											<input class="btn_srh" type="submit" name="ModifyAdmin"
												value="修改"">
