												...
												<div id="inbox" class="tab-pane in active">
													<div class="message-container">
														<div id="id-message-list-navbar" class="message-navbar clearfix">
															<div class="message-bar">
																<div class="message-infobar" id="id-message-infobar">
																	<span class="blue bigger-150">查询结果</span>
																	<span class="grey bigger-110">(具体信息请点击响应书目)</span>
																</div>
														...
														<div class="message-list-container">
															<div class="message-list" id="message-list">
																<div class="message-item message-unread">
																	...
																	<a href="/Library/admin/bool.jsp"><span class="sender" title="Alex John Red Smith">今天天气好晴朗 </span></a>
																...
																<div class="message-item message-unread">
																	...
																	<a href="/Library/admin/bool.jsp"><span class="sender" title="John Doe">
																		哈哈哈哈哈哈哈
																...
																<div class="message-item">
																	...
																	<a href="/Library/admin/bool.jsp"><span class="sender" title="Philip Markov">又是一本书</span></a>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Sabrina">嘿 </span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Philip Markov">啦啦啦啦啦啦 </span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Doctor Gomenz">白日依山尽</span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Robin Hood">黄河入海流 </span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Google Inc">欲穷千里目 </span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Shrek">哎 为什么这么帅</span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
																...
																<div class="message-item">
																	...
																	<span class="sender" title="Yahoo!">要这么多书干嘛？ </span>
																	<span class="time">本馆藏书：4 可借数目：0</span>
														...
														<div class="message-footer clearfix">
															<div class="pull-left">  信息未能全部展示，其余请翻页 </div>
								...
								<div class="hide message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="/Library/assets/avatars/avatar.png" width="32" />
											&nbsp;
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="/Library/assets/images/gallery/thumb-4.jpg" />
												<img width="36" alt="image 3" src="/Library/assets/images/gallery/thumb-3.jpg" />
												<img width="36" alt="image 2" src="/Library/assets/images/gallery/thumb-2.jpg" />
												<img width="36" alt="image 1" src="/Library/assets/images/gallery/thumb-1.jpg" />
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
